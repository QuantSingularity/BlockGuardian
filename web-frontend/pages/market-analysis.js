      ...
      <div className="max-w-7xl mx-auto">
        <div className="mb-8">
          ...
          <p className="text-gray-600 dark:text-gray-300">
            Comprehensive analysis of market trends, economic indicators, and
            sentiment data.
          </p>
        </div>
          ...
          <div className="space-y-4">
            <div className="card p-4">
              ...
              <p className="text-gray-600 dark:text-gray-300 mb-2">
                Our AI models indicate a continued bullish trend in technology
                and healthcare sectors over the next 30 days, with a 78%
                confidence level. Recent economic data supports this projection,
                particularly the strong consumer confidence numbers and easing
                inflation pressures.
              </p>
              <button className="text-indigo-600 dark:text-indigo-400 font-medium hover:underline">
            ...
            <div className="card p-4">
              ...
              <p className="text-gray-600 dark:text-gray-300 mb-2">
                ...
                weeks based on our predictive models. This suggests a
                stabilizing market environment, potentially favorable for
