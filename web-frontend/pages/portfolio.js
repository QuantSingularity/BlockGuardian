      ...
      <div className="max-w-7xl mx-auto">
        <div className="mb-8">
          ...
          <p className="text-gray-600 dark:text-gray-300">
            Track your investment performance, asset allocation, and risk
            ...
            <div className="space-y-4">
              <div className="flex justify-between items-center">
                <div className="flex items-center">
                  <div className="w-8 h-8 bg-blue-100 dark:bg-blue-900 rounded-full flex items-center justify-center text-blue-600 dark:text-blue-300 mr-3">
                    A
                  </div>
              ...
              <div className="flex justify-between items-center">
                <div className="flex items-center">
                  <div className="w-8 h-8 bg-green-100 dark:bg-green-900 rounded-full flex items-center justify-center text-green-600 dark:text-green-300 mr-3">
                    M
                  </div>
                  <span className="text-gray-800 dark:text-white">
                    Microsoft Corp.
              ...
              <div className="flex justify-between items-center">
                <div className="flex items-center">
                  <div className="w-8 h-8 bg-yellow-100 dark:bg-yellow-900 rounded-full flex items-center justify-center text-yellow-600 dark:text-yellow-300 mr-3">
                    T
                  </div>
                  <span className="text-gray-800 dark:text-white">
                    Tesla Inc.
              ...
              <div className="flex justify-between items-center">
                <div className="flex items-center">
                  <div className="w-8 h-8 bg-purple-100 dark:bg-purple-900 rounded-full flex items-center justify-center text-purple-600 dark:text-purple-300 mr-3">
                    A
                  </div>
                  <span className="text-gray-800 dark:text-white">
                    Amazon.com Inc.
              ...
              <div className="flex justify-between items-center">
                <div className="flex items-center">
                  <div className="w-8 h-8 bg-red-100 dark:bg-red-900 rounded-full flex items-center justify-center text-red-600 dark:text-red-300 mr-3">
                    G
                  </div>
                  <span className="text-gray-800 dark:text-white">
                    Google (Alphabet)
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600 dark:text-gray-300 mb-2">
                    Our AI suggests rebalancing your portfolio to reduce
                    technology exposure by 5% and increase healthcare allocation
                    by 3%.
                  </p>
            ...
            <div className="p-4 bg-yellow-50 dark:bg-yellow-900/30 rounded-lg">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600 dark:text-gray-300 mb-2">
                    Our volatility models indicate increased market turbulence
                    ahead. Consider hedging strategies to protect your
                    portfolio.
                  </p>
