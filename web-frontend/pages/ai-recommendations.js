  ...
  const stockRecommendations = [
    {
      ...
      confidence: "High",
      reasoning:
        "Strong product cycle, services growth, and AI integration potential",
    },
    {
      ticker: "MSFT",
      ...
      confidence: "Medium",
      reasoning:
        "Cloud growth remains strong but valuation is approaching full potential",
    },
    {
      ticker: "NVDA",
    ...
    },
    {
      ...
      confidence: "Medium",
      reasoning:
        "Ad revenue recovery balanced against metaverse investment costs",
    },
  ];
  ...
  const marketTrendPredictions = [
    {
      ...
      confidence: "High",
      description:
        "Our AI models predict continued strength in the technology sector, particularly in companies focused on AI, cloud computing, and cybersecurity.",
    },
    {
      ...
      confidence: "Medium",
      description:
        "Expected interest rate stabilization should provide a supportive environment for equities, with potential for multiple expansion in growth stocks.",
    },
    {
      ...
      confidence: "Medium",
      description:
        "Consumer spending may face headwinds in the near term as inflation impacts continue to be felt, suggesting selective positioning in this sector.",
    },
    {
      ...
      confidence: "High",
      description:
        "Breakthrough technologies in genomics, precision medicine, and AI-driven diagnostics position the healthcare innovation segment for strong long-term growth.",
    },
  ];
      ...
      <div className="max-w-7xl mx-auto">
        <div className="mb-8">
          ...
          <p className="text-gray-600 dark:text-gray-300">
            Advanced machine learning models providing investment insights and
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 mb-8">
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400 mt-2">
            Our AI models have consistently improved in accuracy over time, with
            the latest ensemble approach achieving over 90% accuracy in market
            trend predictions.
          </p>
        </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 mb-8">
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400 mt-2">
            Comparison of our different AI models across key performance
            metrics. The ensemble approach combines the strengths of individual
            models for superior results.
          </p>
        </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 mb-8">
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400 mt-2">
            Our AI-optimized portfolio aims to maximize the Sharpe ratio,
            providing better risk-adjusted returns compared to traditional
                  ...
                  <span
                    className={`px-2 py-1 text-xs font-semibold rounded-full ${
                      trend.prediction.includes("Bullish")
                        ? "bg-green-100 text-green-800 dark:bg-green-900 dark:text-green-200"
                        : trend.prediction.includes("Cautious") ||
                            trend.prediction.includes("Neutral")
                          ? "bg-yellow-100 text-yellow-800 dark:bg-yellow-900 dark:text-yellow-200"
                          : "bg-red-100 text-red-800 dark:bg-red-900 dark:text-red-200"
                    }`}
                  >
        ...
        <div className="bg-indigo-50 dark:bg-indigo-900/20 rounded-xl shadow-lg p-6 mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-white dark:bg-gray-800 rounded-lg p-4">
              ...
              <p className="text-gray-600 dark:text-gray-300">
                Long Short-Term Memory networks excel at capturing temporal
                dependencies in financial time series data, enabling accurate
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg p-4">
              ...
              <p className="text-gray-600 dark:text-gray-300">
                ...
                are specifically designed to capture volatility clustering in
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg p-4">
              ...
              <p className="text-gray-600 dark:text-gray-300">
                Our ensemble approach combines multiple models to leverage their
                individual strengths, resulting in more robust and accurate
                predictions across various market conditions.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 mb-8">
          <div className="flex items-start mb-6">
            ...
            <div>
              ...
              <p className="text-gray-600 dark:text-gray-300">
                Complete your risk profile and investment goals to receive
                tailored AI-powered investment recommendations.
              </p>
            </div>
          </div>
          <div className="bg-indigo-50 dark:bg-indigo-900/20 rounded-lg p-6 text-center">
            <h3 className="text-lg font-medium text-gray-800 dark:text-white mb-4">
              Ready to optimize your portfolio with AI?
            </h3>
